package com.blorferind.jeep.errorhandler;
...
public class GlobalErrorHandler {
  ...
  public Map<String, Object> handleMethodArgumentTypeMismatchExceptionn(MethodArgumentTypeMismatchException e, WebRequest webRequest) {
  ...
  @ResponseStatus(code = HttpStatus.BAD_REQUEST)
  public Map<String, Object> handleConstraintViolationExceptiion(
